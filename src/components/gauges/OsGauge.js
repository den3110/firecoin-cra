...
const OsGauge = ({ result }) => {
    ...
    return (
        <div className="gauge-meter-sub gauge-meter--os">
            ...
            <h4 className="gauge-meter-sub-title">{convertTextValueMeter(result.oscillators.meter.numberValue)}</h4>
                ...
                <HighchartsReact
                    ...
                    options={{
                        chart: {
                            ...
                            events: {
                                render: function () {
                                    result.oscillators.meter.textValue = convertTextValueMeter(
                                        result.oscillators.meter.numberValue,
                                    );
                                },
                            },
                            animation: {
                        ...
                        series: [
                            {
                                name: "Oscillator",
                                data: [result.oscillators.meter.numberValue],
                                yAxis: 0,
                            },
                        ],
                        responsive: {
