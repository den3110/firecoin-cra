                    ...
                    <div className="border-[2px] border-jackpot-primary bg-secondarySidebar rounded-[30px] p-0 relative flex flex-col w-full outline-0">
                        <header
                            className={clsx(
                                ...
                                "before:content-[''] before:block before:w-[494px] before:h-[294px] before:bg-[url('~/public/assets/images/img-2.png')] before:bg-cover before:absolute before:-translate-y-1/2",
                                "after:contet-[''] after:block after:w-[188px] after:h-[188px] after:bg-[url('~/public/assets/images/box-6.png')] after:bg-cover after:absolute after:-top-[120px] after:left-1/2 after:-translate-x-1/2",
                            )}
                        >
