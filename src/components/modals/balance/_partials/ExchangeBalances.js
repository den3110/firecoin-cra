...
const ExchangeBalances = () => {
    ...
    const LiveAccount = (
        <div
            className={clsx(
                "bg-[url('http://localhost:3001/assets2/images/livebanner.png')] bg-cover bg-no-repeat bg-[50%] rounded-[10px] relative",
    ...
    const DemoAccount = (
        <Loading loading={isRefilling}>
            <div
                className={clsx(
                    "bg-[url('http://localhost:3001/assets2/images/winbanner.png')] bg-cover bg-no-repeat bg-[50%] rounded-[10px] relative",
