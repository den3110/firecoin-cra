        ...
        <div className="main-banner-inner">
          <div className="flex flex-wrap items-center">
            <div className="w-full lg:w-1/2 md:w-full sm:w-full px-4 main-banner-content">
              <h3 className="main-banner-sub-title">
                {t("train_smarter_get_stronger")}
              </h3>
              <h2 className="main-banner-title">
                {t("an_ideal_platform_to_earn")}
              </h2>
              <p className="main-banner-description">
                {t("site_is_the_world_premier_trading_platform", {
                  site: getCurrentSiteName(),
                })}
              </p>
              <Link
                href="/login"
          ...
          <span
            className="main-banner-icon"
            onClick={() => smoothScrollTo("trading-platform")}
          >
            <img src={imgIconArrowDown} alt="" />
          </span>
        </div>
      </section>
            ...
            <div className="lg:w-1/2 w-full mt-6 lg:mt-0">
              <div className="trading-platform-content-text">
                ...
                <p className="trading-platform-desc">
                  {t("develops_extremely_advanced_but_simple_to_use", {
                    site: getCurrentSiteName(),
                  })}
                </p>
                <Link
          ...
          <h2 className="how-we-work-title">
            <div
              dangerouslySetInnerHTML={{
                __html: t("a_platform_built_on_innovation"),
              }}
            />
          </h2>
          <span className="how-we-work-icon">
            <img src={imgIconLogo} alt="" />
          </span>
          <ul className="how-we-work-list">
            <li className="how-we-work-item">
              <img src={imgIcons1} alt="" className="how-we-work-item-icon" />

              <h4 className="how-we-work-item-title">Stable &amp; Secure</h4>
              <p className="how-we-work-item-text">
                Our platform is highly stable and available worldwide. We
                protect your assets with best security methods.
              </p>
            </li>
            <li className="how-we-work-item">
              <img src={imgIcons2} alt="" className="how-we-work-item-icon" />
              <h4 className="how-we-work-item-title">Refer &amp; Earn</h4>
              <p className="how-we-work-item-text">
                Refer your friends and earn together by trading on{" "}
                {getCurrentSiteName()}.
              </p>
            </li>
            <li className="how-we-work-item">
              <img src={imgIcons3} alt="" className="how-we-work-item-icon" />
              <h4 className="how-we-work-item-title">Fast &amp; Free</h4>
              <p className="how-we-work-item-text">
                No deposit fee and small withdrawal fee. Transactions arrives
                within minutes.
              </p>
            </li>
          </ul>
      ...
      <section className="list-coin bg-gradient-primary">
        <div className="coin-wrap">
          <div className="image-wrap">
            <img src={imgBSC} className="image" alt="bsc" />
          </div>
          <div className="image-wrap">
            <img src={imgBTC} className="image" alt="btc" />
          </div>
          <div className="image-wrap">
            <img src={imgUSDT} className="image" alt="usdt" />
          </div>
        </div>
      </section>
      ...
      <section className="get-started-in-steps text-center">
        <div className="max-w-custom-container mx-auto pr-4 pl-4">
          <h2 className="get-started-in-steps-title">
            <div
              dangerouslySetInnerHTML={{
                __html: t("ltptrade_get_started_title"),
              }}
            />
          ...
          <ul className="get-started-in-steps-list">
            <li className="get-started-in-steps-item">
              ...
              <h4 className="get-started-in-steps-item-title">
                {" "}
                {t("sign_up")}
              </h4>
            ...
            <li className="get-started-in-steps-item">
              ...
              <p className="get-started-in-steps-item-text">
                {t("deposit_using_popular_cryptocurrency")}
              </p>
            </li>
            <li className="get-started-in-steps-item">
              <span className="get-started-in-steps-item-icon">
                <img src={imgIcons6} alt="" />
              </span>
              ...
              <p className="get-started-in-steps-item-text">
                {t("make_money_predicting_the_price_of_assets")}
              </p>
            </li>
          </ul>
          <div className="get-started-in-steps-icon">
            <img src={imgIconWeight} alt="" />
          </div>
        </div>
      </section>
          ...
          <div className="flex justify-center">
            <div className="lg:w-2/3">
              <h2 className="our-portfolio-title">
                <div
                  dangerouslySetInnerHTML={{
                    __html: t("anywhere_you_want"),
                  }}
                />
              </h2>
              <p className="our-portfolio-text">
                {t("everyone_can_earn_sustainable", {
                  site: getCurrentSiteName(),
                })}
              </p>
              <Link
