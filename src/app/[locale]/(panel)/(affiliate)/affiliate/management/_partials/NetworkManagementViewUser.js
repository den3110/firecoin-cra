...
const NetworkManagementUserStat = lazy(() =>
  import(
    "@/app/[locale]/(panel)/(affiliate)/affiliate/management/_partials/NetworkManagementUserStat"
  )
);
              ...
              >
                ...
                <div className="body">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-[15px]">
                    <div>
                      <p className="text-light/50 text-sm mb-2">
                        {t("total_referrals")}
                      </p>
            ...
            <div className="mb-4">
              ...
              >
                <div className="w-full mx-[15px]">
                  ...
                  <span className="text-light text-xl ml-2">
                    {t("information")}
                  </span>
                </div>
                <div className="w-full px-[15px] lg:mt-6">
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-x-[30px] w-full">
                    ...
                    <div className="md:col-span-7">
                      ...
                      <p className="text-light/50 mt-0 mb-4">
                        {t("phone_number")}
                      </p>
                      <p className="text-ellipsis whitespace-nowrap overflow-hidden mb-4">
                        <svg
