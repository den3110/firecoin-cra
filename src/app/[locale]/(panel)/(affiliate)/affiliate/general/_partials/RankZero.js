...
const RankZero = () => {
    ...
    return (
        <div>
            <div className="banner bg-[url('http://localhost:3001/assets2/images/affiliate_bg.png')] relative w-full min-h-[calc(100vh-185px)] max-[450px]:min-h-[550px] bg-cover bg-no-repeat bg-top">
