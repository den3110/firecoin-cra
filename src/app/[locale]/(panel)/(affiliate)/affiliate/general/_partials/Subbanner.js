                            ...
                            <div>
                                <div className="h-full items-center flex">
                                    <div className="flex items-center">
                                        <div className="">
                                            <div className="bg-[url('~/public/assets/images/invite-1.svg')] w-[52px] h-[55px] mr-4 bg-cover bg-no-repeat"></div>
                                        </div>
                                        <div>
                        ...
                        <swiper-slide>
                            <div>
                                <div className="h-full items-center flex">
                                    <div className="flex items-center">
                                        <div className="">
                                            <div className="bg-[url('~/public/assets/images/invite-2.svg')] w-[52px] h-[55px] mr-4 bg-cover bg-no-repeat"></div>
                                        </div>
                                        <div>
                                            <div className="text-content">
                        ...
                        <swiper-slide>
                            <div>
                                <div className="h-full items-center flex">
                                    <div className="flex items-center">
                                        <div className="">
                                            <div className="bg-[url('~/public/assets/images/invite-3.svg')] w-[52px] h-[55px] mr-4 bg-cover bg-no-repeat"></div>
                                        </div>
                                        <div>
                                            <div className="text-content">
