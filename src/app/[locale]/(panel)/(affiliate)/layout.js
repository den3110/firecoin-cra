...
const AffiliateLayout = ({ children }) => {
    ...
    return (
        <div
            className={clsx({
                "bg-[url('http://localhost:3001/assets2/images/upgrade-agency.png')] min-h-[calc(100vh-65px)] bg-cover bg-[top_20px_center] bg-no-repeat pb-[50px]":
                    ...
                    <div className="balance-link bg-custom-chart-title mb-6">
                        <div className="px-[15px] w-screen lg:w-auto">
                            ...
                            >
                                ...
                                <li className="nav-item relative before:top-[20px] before:right-0 before:min-[1200px]:top-0 before:min-[1200px]:-right-[15px] before:absolute before:bg-[url('http://localhost:3001/assets2/images/icon-new.svg')] before:block before:overflow-hidden before:w-[25px] before:h-[21px] before:content-[''] before:bg-[length:100%_100%]">
                                    <Link
                                        href="/upgrade-vip"
                                        className={clsx("nav-link", {
