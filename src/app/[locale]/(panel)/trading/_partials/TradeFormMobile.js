...
function TradeFormMobile({symbol}) {
    ...
    return (
    <div className="border border-custom-border bg-secondarySidebar p-3" style={{ height: "700px" }}>

              <div className="w-full mb-4">
            <p className="sm:text-xs lg:text-sm text-light mb-2 sm:block">{t("type")}</p>

      <div className="mt-2 grid grid-cols-4 lg:grid-cols-2 gap-[6px]">
        ...
        >
            ...
            <div className="mt-2 hidden lg:grid grid-cols-3 gap-[6px]">
               ...
               <div className="mt-2 sm:mt-0 lg:mt-2">
                    <div className="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-1 lg:gap-3">
                        <button
